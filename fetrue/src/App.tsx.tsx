...
import growth from "@/assets/gallery-growth.jpg";ff
import horizon from "@/assets/gallery-horizon.jpg";f
      ...
      <header className="sticky top-0 z-30 backdrop-blur-xl bg-background/70 border-b border-border/60">
        <div className="mx-auto max-w-md grid grid-cols-[minmax(0,1fr)_auto] items-center gap-3 px-4 py-3">
          <div className="flex min-w-0 items-center gap-3">
            <img src={logo} alt="Fetrue" className="h-10 w-10 shrink-0 rounded-xl object-cover shadow-soft" />
    ...
    <div className="space-y-5 animate-float-in">
      <section className="rounded-3xl bg-card p-6 shadow-soft">
        <div className="flex items-center gap-4">
          <img src={logo} alt="Fetrue" className="h-14 w-14 rounded-xl object-cover" />
          <div className="min-w-0">
